<?php
    ...
    if ($exe_nome == "" || $ser_serie == "") {
        header("location: ../criarTreino.php?membro=Costa&situacao=faltando");
    }else{
        ...
        WHERE 
            u.usu_id = 1 AND mt.mem_nome = 'Costa'";
        ...
        $sql = "INSERT INTO series_exercicios(ser_serie, ser_ordem, exe_nome, mem_nome) VALUES ('$ser_serie','$ser_ordem','$exe_nome','Costa')";
        ...
        header("location: ../criarTreino.php?membro=Costa");
    }
?>