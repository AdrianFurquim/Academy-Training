<?php
    ...
    WHERE 
        u.usu_id = 1 AND mt.mem_nome = 'Ombro'";
    ...
    $sql = "INSERT INTO series_exercicios(ser_serie, ser_ordem, exe_nome, mem_nome) VALUES ('$ser_serie','$ser_ordem','$exe_nome','Ombro')";
    ...
    header("location: ../criarTreino.php?membro=Ombro");
?>